...
not_normalized = tutil.all_not_normalized_lists()
normalized = tutil.all_normalized_lists()
...
class TestMessage:
    def test__normalized(self):
        for i, norm in enumerate(tutil.all_normalized_lists()):
            assert_normalized(norm)
        
        for i, notnorm in enumerate(tutil.all_not_normalized_lists()):
            assert_not_normalized(notnorm)
        ...
        assert_not_normalized(sixteen_not_normalized)
        assert_normalized(sixteen_not_normalized.normalized)
        assert_normalized(sixteen_normalized)
    ...
    def test__from_file__normalized(self):
        ...
        assert_normalized(no_chords_file)
        ...
        assert_normalized(fur_elise_10_normalized_file)
        ...
        assert_normalized(fur_elise_half_tempo)
