...
const big = {
    ...
    async threeButtons(options) {
        ...
        const onBeforeOpen = (modal) => {
            ...
            el.actions.append(betterhtmlelement_1.button({ cls: `swal2-confirm swal2-styled`, html: options.thirdButtonText })
                .css(thirdButtonCss)
                .click(async (ev) => {
                action = "third";
