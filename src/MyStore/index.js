    ...
    get dev() {
        ...
        return {
            ...
            skip_whole_truth: (where) => {
                ...
                if (skip_whole_truth)
                    console.warn(`devoptions.skip_whole_truth ${where}`);
